...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/9a16df3f-29fc-49f7-b281-9b8238bc6334", {
        name: clientName,
        email: email,
        message: messages,
      });
    ...
    <div className="w-full">
      ...
      <div className="w-full mt-10">
        ...
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/9a16df3f-29fc-49f7-b281-9b8238bc6334"
            method="POST"
